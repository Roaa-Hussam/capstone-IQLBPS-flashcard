...
const HeroHome = () => {
  return (
    ...
    >
      ...
      <h1 className="ml-24 text-primary-500  sm:text-5xl  md:text-6xl lg:text-8xl tracking-tight leading-none font-bold">
        Card<span className="text-primary-500">ly</span>
      </h1>
      <p className="mt-4 mx-24  md:text-xs lg:text-xl text-gray-800 dark:text-gray-400 text-opacity-75">
        Create Flashcards
        <br />
        and study easily from any part of the world.
      </p>
      <p className="mx-24 mt-16">
        <Link
          to="/login"
